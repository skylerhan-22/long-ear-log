  ...
  return (
    <main className="app-shell"><section className="phone-frame">
      {tab === "today" && !workoutOpen && !foodEntryOpen && <div className="page-view">
        ...
        <section className="hero-panel"><div><span className="chapter">今日 · CHAPTER 04</span><h2>{workoutDone ? "训练完成，记上一笔。" : "今天，动一点就好。"}</h2><p>本周已完成 {weekCompleted} / {weekTrainingCount} 次训练</p></div><img src={workoutDone ? "/rabbit-today-complete.png" : "/rabbit-today-wave.png"} alt="" className="hero-mascot" /></section>
      ...
      {tab === "profile" && <div className="page-view">
        ...
        <section className="profile-hero"><div><span className="kicker">训练日志者</span><h2>Mia</h2><p>目标：增肌与体能</p></div><img src="/rabbit-profile-checklist.png" alt="" className="profile-mascot" /></section>
