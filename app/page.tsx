  ...
  return (
    <main className="app-shell"><section className="phone-frame">
      {tab === "today" && !workoutOpen && !foodEntryOpen && <div className="page-view">
        ...
        <section className="hero-panel"><div><span className="chapter">今日 · CHAPTER 04</span><h2>{workoutDone ? "训练完成，记上一笔。" : "今天，动一点就好。"}</h2><p>本周已完成 {workoutDone ? 3 : 2} / 4 次训练</p></div><Sprite sheet="today" col={0} row={workoutDone ? 2 : 0} className="hero-mascot" /></section>
